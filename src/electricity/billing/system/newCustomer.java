...
public class newCustomer extends JFrame implements ActionListener{
    ...
    newCustomer(){
      ...
      long number = ran.nextLong() % 1000000; // generating a random number of 6 digits
      meternumText.setText("" + Math.abs(number)); // setting the 6 didgit no in meternumtext feild
